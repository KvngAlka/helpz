...
const NavLink = ({link,title, active})=>{
    return(
        <Link href={link}>
            <a  className={`${active && styles.nav_active } `}>{title}</a>
        </Link>
    )
}
  ...
  return (
    <div className={styles.navbar}>
        ...
        <div className={styles.nav_links}>
            <NavLink title={'Chat'} active = {navigate.pathname === "/"} link = {'/'}/>
            <NavLink title={'News'} active ={navigate.pathname === '/news'} link = {'/news'}/>
            <NavLink title={'Settings'} active ={navigate.pathname === '/settings'} link = {'/settings'}/>
        </div>
